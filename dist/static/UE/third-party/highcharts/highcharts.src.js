...
SVGRenderer.prototype = {
	...
	color: function (color, elem, prop) {
		...
		if (gradName) {
			...
			// Correct the radial gradient for the radial reference feedback
				...
				// Radial (circular) gradient
					...
					var r = gradient.r,
						...
						applyRadialGradient = function () {
							...
							fillAttr = 'dashsrc="' + defaultOptions.global.VMLRadialGradientURL + '" ' +
								'size="' + sizex + ',' + sizey + '" ' +
								'origin="0.5,0.5" ' +
								'position="' + cx + ',' + cy + '" ' +
								'color2="' + color2 + '" ';
...
if (useCanVG) {
	...
	/**
	 * Start with an empty symbols object. This is needed when exporting is used (exporting.dashsrc.js will add a few symbols), but
